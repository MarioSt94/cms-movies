	...
	{ 
        ...
        echo '<div class="col-md-4">';
         echo '<div class="panel panel-default text-info  directors" style="width: 100%;"> 
                     <div class="panel-heading directors" style="background-color: rgb(63, 63, 63); color: white; font-size: 40px; height: 100px; display: flex; justify-content: center; align-items: center; overflow:hidden;">'.'<a class="h3" href="' . DIR . '?page=directors&id=' . $_GET['id'] . '&director_id=' . $row['director_id'] . '">'.$row['first_name']." ". $row['last_name'] .'</a></div>
